...
Stage 03  data_merge_new.py         ─► master_lookup_table.csv
          ...
          final_filtering_v2.py     ─► PinkPigeon_Final_Filtered_List.csv
          compute_og_stats.py       ─► ..._with_OG_stats.csv (+ OG_stats_summary.tsv)
          compute_orthology_stats.py─► ..._with_OG_stats_and_orthology.csv

Stage 04  merge_immune_annotations.py           ─► PinkPigeon_Immune_Gene_Master_List.csv
          add_gene_info_3.py                    ─► PinkPigeon_Immune_Annotated_Final.csv
          process_ppg_genes.py                  ─► PinkPigeon_Immune_Predict_Result_Final.csv
...
Sex chromosomes are identified by their **original** IDs before renaming.
...
- Out: `PinkPigeon_Final_Filtered_List.csv`
...
- Out: `OG_stats_summary.tsv`, `PinkPigeon_Final_Filtered_List_with_OG_stats.csv`
...
- In: `PinkPigeon__v__{species}.tsv`, `master_lookup_table.csv`,
  `..._with_OG_stats.csv`
...
- In: `interproscan_immune_results.csv`, `PinkPigeon_Final_Filtered_List.csv`,
  `final_kofam_annotated.tsv`, GFF3
- Out: `PinkPigeon_Immune_Gene_Master_List.csv`

### `add_gene_info_3.py`
Enrich with `gene_info.csv` via an all-in symbol strategy (PPG native, Chicken,
ZebraFinch, Mouse, Kofam symbols).
- Out: `PinkPigeon_Immune_Annotated_Final.csv`, `Unmapped_Gene_Info_Symbols.txt`
...
- Out: `PinkPigeon_Immune_Predict_Result_Final.csv`
...
- In: `..._with_OG_stats.csv`, `PinkPigeon_Immune_Predict_Result_Final.csv`, GFF3
- Out: `PinkPigeon_Immune_Predict_Result_Final_with_OG_stats.csv`,
...
- Out: `PinkPigeon_Immune_Predict_Result_Final_with_OG_and_Orthology.csv`
